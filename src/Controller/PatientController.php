...
class PatientController extends AbstractController
{
    ...
    /**
     * @Route("/P", name="patient_indexP", methods={"GET"})
     */
    public function indexP(PatientRepository $patientRepository): Response
    {


        return $this->render('frontP/indexP.html.twig', [
            'patients' => $patientRepository->findAll(),
...
// Configure Dompdf according to your needs
        ...
        $html = $this->renderView('patient/patient_pdf.html.twig', [
            'title' => "Welcome to our PDF Test", "patient" => $patient
        ]);
    ...
    /**
     * @Route("/{id}", name="patient_show1", methods={"GET"})
     */
    public function showP(Patient $patient): Response
    {
        return $this->render('frontP/patientShow.html.twig', [
            'patient' => $patient,
        ]);
    }
